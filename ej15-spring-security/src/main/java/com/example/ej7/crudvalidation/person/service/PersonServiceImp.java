...
public class PersonServiceImp implements PersonService{
    ...
    public void createPerson(PersonInputDTO personInputDTO) throws Exception
    {
        ...
        if(person.getAdmin() == null) {
            throw new UnprocessableEntityException("admin no puede ser nulo",422);
        }
    ...
    public void updatePerson(PersonInputDTO personInputDTO, String idPerson) throws Exception
    {
        ...
        if (personOptional.isPresent())
        {
            ...
            person.setAdmin(personInputDTO.getAdmin());
            ...
            person.setTerminationDate(personInputDTO.getTerminationDate());
